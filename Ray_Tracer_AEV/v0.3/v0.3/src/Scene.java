...
public class Scene {
    ...
    public Vector3D getLightPosition()   { return lightPosition;   }

    /**
     * Returns the closest intersection along the ray, ignoring hits outside
     * [tNear, tFar] (near & far clipping – slide 3).
     */
    public Intersection intersect(Ray ray, double tNear, double tFar) {
        ...
        for (Object3D object : objects) {
            ...
            // Near & Far clipping: discard intersections outside the clip range
    ...
    /** Convenience overload without explicit clipping (uses full range). */
