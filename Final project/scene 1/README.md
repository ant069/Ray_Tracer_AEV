...
### 📖 NARRATIVA
**"Crystal Geometry"** - Una composición artística que explora cómo la luz se comporta de manera diferente según los materiales. Una gran pirámide de vidrio refracta la luz, creando un foco visual hipnótico. Pequeñas esferas metálicas reflejan la escena dramáticamente. El piso es un espejo perfecto que duplica la complejidad visual.

**Historia que cuenta:** La transformación de la luz a través de diferentes medios - refracción en vidrio, reflexión en metal, multiplicación en espejos.
...
# La imagen se guardará en: output/Scene_1_Preview_1024x576.png
```
...
# La imagen final se guardará en: output/Scene_1_FINAL_4096x2160.png
```
...
└── scene 1/
    ...
    │
    └── output/
        └── Scene_1_Preview_1024x576.png  (después de ejecución)
        └── Scene_1_FINAL_4096x2160.png   (si isFinalRender=true)
```
